...
export default function TermsOfService() {
  return (
    ...
    >
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-semibold text-foreground">2. Üyelik</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-semibold text-foreground">3. Satın Alma</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-semibold text-foreground">4. Yasaklı Kullanımlar</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-semibold text-foreground">6. Uyuşmazlık</h2>
        <p>
