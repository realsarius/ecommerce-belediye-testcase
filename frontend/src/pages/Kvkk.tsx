...
export default function Kvkk() {
  return (
    ...
    >
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-semibold text-white">İşlenen Veri Kategorileri</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-semibold text-white">İşleme Amaçları</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-semibold text-white">Aktarım</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-semibold text-white">Saklama Süresi</h2>
        <p>
