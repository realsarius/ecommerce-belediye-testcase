  ...
  return (
    ...
    >
      <section className="space-y-3">
        <h2 className="text-xl font-semibold text-foreground">Taraflar</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-semibold text-foreground">Konu</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-semibold text-foreground">Teslimat</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-semibold text-foreground">Cayma Hakkı</h2>
        <p>
