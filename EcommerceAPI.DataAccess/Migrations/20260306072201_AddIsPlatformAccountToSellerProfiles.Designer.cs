...
namespace EcommerceAPI.DataAccess.Migrations
{
    ...
    [Migration("20260306072201_AddIsPlatformAccountToSellerProfiles")]
    partial class AddIsPlatformAccountToSellerProfiles
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcommerceAPI.Entities.Concrete.ContactMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EcommerceAPI.Entities.Concrete.GiftCard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("TBL_GiftCards", (string)null);
                });

            modelBuilder.Entity("EcommerceAPI.Entities.Concrete.GiftCardTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("TBL_GiftCardTransactions", (string)null);
                });
            ...
            modelBuilder.Entity("EcommerceAPI.Entities.Concrete.LoyaltyTransaction", b =>
                {
                    ...
                    b.ToTable("TBL_LoyaltyTransactions", (string)null);
                });
            ...
            modelBuilder.Entity("EcommerceAPI.Entities.Concrete.NotificationPreference", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("TBL_NotificationPreferences", (string)null);
                });

            modelBuilder.Entity("EcommerceAPI.Entities.Concrete.NotificationTemplateSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("TitleExample")
                        .IsRequired()
                        .HasMaxLength(256)
                    ...
                    b.ToTable("TBL_NotificationTemplateSettings", (string)null);
                });
            ...
            modelBuilder.Entity("EcommerceAPI.Entities.Concrete.ReferralCode", b =>
                {
                    ...
                    b.ToTable("TBL_ReferralCodes", (string)null);
                });

            modelBuilder.Entity("EcommerceAPI.Entities.Concrete.ReferralTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("TBL_ReferralTransactions", (string)null);
                });
            ...
            modelBuilder.Entity("EcommerceAPI.Entities.Concrete.SellerProfile", b =>
                {
                    ...
                    b.Property<string>("BannerImageObjectKey")
                        .HasMaxLength(1024)
                        .HasColumnType("character varying(1024)");
            ...
            modelBuilder.Entity("EcommerceAPI.Entities.Concrete.User", b =>
                {
                    ...
                    b.Property<int>("EmailVerificationCodeAttemptCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);
                    ...
                    b.Property<DateTime?>("EmailVerificationCodeLockedUntil")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<int?>("ReferralRewardedOrderId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ReferralRewardedOrderId");
            ...
            modelBuilder.Entity("EcommerceAPI.Entities.Concrete.GiftCard", b =>
                {
                    b.HasOne("EcommerceAPI.Entities.Concrete.User", "AssignedUser")
                        .WithMany("GiftCards")
            ...
            modelBuilder.Entity("EcommerceAPI.Entities.Concrete.GiftCardTransaction", b =>
                {
                    b.HasOne("EcommerceAPI.Entities.Concrete.GiftCard", "GiftCard")
            ...
            modelBuilder.Entity("EcommerceAPI.Entities.Concrete.ReferralCode", b =>
                {
                    b.HasOne("EcommerceAPI.Entities.Concrete.User", "User")
                        ...
                        .HasForeignKey("EcommerceAPI.Entities.Concrete.ReferralCode", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EcommerceAPI.Entities.Concrete.ReferralTransaction", b =>
                {
                    b.HasOne("EcommerceAPI.Entities.Concrete.User", "BeneficiaryUser")
                        .WithMany("ReferralTransactionsAsBeneficiary")
                        .HasForeignKey("BeneficiaryUserId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("EcommerceAPI.Entities.Concrete.Order", "Order")
                        .WithMany("ReferralTransactions")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("EcommerceAPI.Entities.Concrete.ReferralCode", "ReferralCode")
                        .WithMany("ReferralTransactions")
                        .HasForeignKey("ReferralCodeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("EcommerceAPI.Entities.Concrete.User", "ReferredUser")
                        .WithMany("ReferralTransactionsAsReferred")
                        .HasForeignKey("ReferredUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("EcommerceAPI.Entities.Concrete.User", "ReferrerUser")
                        .WithMany("ReferralTransactionsAsReferrer")
            ...
            modelBuilder.Entity("EcommerceAPI.Entities.Concrete.User", b =>
                {
                    b.HasOne("EcommerceAPI.Entities.Concrete.ReferralCode", null)
                        .WithMany()
                        .HasForeignKey("AppliedReferralCodeId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("EcommerceAPI.Entities.Concrete.Order", null)
                        .WithMany()
                        .HasForeignKey("ReferralRewardedOrderId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("EcommerceAPI.Entities.Concrete.User", "ReferredByUser")
            ...
            modelBuilder.Entity("EcommerceAPI.Entities.Concrete.Order", b =>
                {
                    ...
                    b.Navigation("ReferralTransactions");
                });
            ...
            modelBuilder.Entity("EcommerceAPI.Entities.Concrete.User", b =>
                {
                    ...
                    b.Navigation("ReferralTransactionsAsBeneficiary");

                    b.Navigation("ReferralTransactionsAsReferred");

                    b.Navigation("ReferralTransactionsAsReferrer");
